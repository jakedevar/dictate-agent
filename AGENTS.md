...
### 1. The Orchestrator Daemon: [DictateAgent](file:///home/jakedevar/dictate_agent/src/agent.rs#L18-L29)
...
### 2. Audio Capture Engine: [AudioCapture](file:///home/jakedevar/dictate_agent/src/audio.rs#L7-L11)
...
### 3. Speech-to-Text Pipeline: [Transcriber](file:///home/jakedevar/dictate_agent/src/transcribe.rs#L15-L20)
...
### 4. Grammar Correction Agent: [GrammarCorrector](file:///home/jakedevar/dictate_agent/src/grammar.rs#L20-L27)
...
### 5. Routing & Dispatch: [router](file:///home/jakedevar/dictate_agent/src/router.rs#L2-L9)
...
|---|---|---|---|
| None (Default) | `Type` | [OutputHandler](file:///home/jakedevar/dictate_agent/src/output.rs#L6-L8) | Paste text directly into the focused window. |
| `timer` | `Timer` | [TimerExecutor](file:///home/jakedevar/dictate_agent/src/timer.rs#L287-L290) | Schedules a systemd user timer. |
| `easy`, `simple`, `medium`, `hard` | `Local` | [LocalExecutor](file:///home/jakedevar/dictate_agent/src/local_executor.rs#L12-L17) | Executes prompt with local Ollama LLM and types result. |
...
### Output Agent: [OutputHandler](file:///home/jakedevar/dictate_agent/src/output.rs#L6-L8)
...
### Local LLM Agent: [LocalExecutor](file:///home/jakedevar/dictate_agent/src/local_executor.rs#L12-L17)
...
### Timer Agent: [TimerExecutor](file:///home/jakedevar/dictate_agent/src/timer.rs#L287-L290)
...
## History & Telemetry Store: [HistoryStore](file:///home/jakedevar/dictate_agent/src/history.rs#L11-L15)
